...
The current implementation processes devices sequentially.

For a larger number of devices, the project could use:
...
This removes the need to manually maintain `file.txt`.

---

## Integrate with Nautobot

Another evolution would be:
...
This would connect this small Netmiko project with the broader Nautobot/AWX automation workflow.

---

# Project Roadmap

- [x] Connect to Cisco IOS devices
- [x] Read multiple devices from a file
- [x] Execute `show ip int br`
- [x] Display command output
- [ ] Remove hard-coded credentials
- [ ] Fix inventory filename mismatch
...
- [ ] Add Nautobot integration
- [ ] Add Ansible/AWX integration
- [ ] Add CI/CD testing
...
This project demonstrates several fundamental network-automation concepts:
...
It can serve as a starting point for moving from manual Cisco CLI operations toward repeatable network automation.
